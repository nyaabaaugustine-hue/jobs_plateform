...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 right-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-6 sm:right-[100px] sm:top-auto sm:p-0 sm:flex-col md:max-w-[380px]",
      className
    )}
    {...props}
  />
  ...
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-right-full",
  {
    variants: {
      variant: {
        ...
        vibrant:
          "vibrant group border-transparent bg-primary text-primary-foreground",
        black: "black group border-gold/20 bg-black text-white shadow-[0_0_20px_rgba(0,0,0,0.5)]",
      },
    },
    defaultVariants: {
      variant: "default",
...
>(({ className, variant = "default", ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "group-[.black]:border-white/30 group-[.black]:text-white group-[.black]:hover:bg-white/10 group-[.black]:hover:text-white",
      className
    )}
    {...props}
  />
