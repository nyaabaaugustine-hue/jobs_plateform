...
export default function AdPanel({ isOpen, onClose, ad }: AdPanelProps) {
  ...
  return (
    <>
      ...
      >
        <Card
          className="overflow-hidden shadow-[0_25px_60px_rgba(0,0,0,0.3)] group border-2 border-gold/10 bg-card/95 backdrop-blur-xl rounded-2xl"
        >
          <Button
            variant="ghost"
            size="icon"
          ...
          <div className="relative">
            ...
            <div className="absolute top-3 left-3 flex gap-2">
                <div className="bg-white/95 px-3 py-1.5 rounded-sm border-l-[3px] border-gold shadow-lg">
                    <span className="font-headline text-[10px] font-black tracking-[0.3em] uppercase text-gold">
                        ADVERTISEMENT
                    </span>
                </div>
            </div>
          ...
          <CardContent className="p-6 flex flex-col">
              <h3 id="ad-panel-headline" className="font-headline text-lg font-black text-foreground leading-tight group-hover:text-gold transition-colors">
                {ad.headline}
              </h3>
            ...
            <div className="pt-4 mt-4 border-t border-border/50 flex flex-col gap-2">
              <Button 
                asChild 
                className="w-full h-10 bg-white text-black border-2 border-black ring-2 ring-gold ring-offset-0 font-headline font-black tracking-wide hover:bg-gold hover:text-black hover:scale-[1.02] transition-all rounded-xl shadow-lg"
              >
              ...
              <Button 
                asChild 
                variant="outline"
                className="w-full h-10 bg-background text-gold border-2 border-gold font-headline font-black hover:bg-gold hover:text-black transition-all rounded-xl shadow-sm"
              >
                <Link href="/contacts">
