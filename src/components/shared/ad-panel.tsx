    ...
    <>
      ...
      <aside
        ...
        className={cn(
          ...
          'data-[state=open]:animate-in data-[state=open]:slide-in-from-left-[-100%] data-[state=open]:duration-700 ease-out',
          'data-[state=closed]:animate-out data-[state=closed]:slide-out-to-left-[-100%] data-[state=closed]:duration-500 ease-in',
          'data-[state=closed]:pointer-events-none'
        )}
        role="dialog"
        aria-modal="true"
