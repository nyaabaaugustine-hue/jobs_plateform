    ...
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/80 backdrop-blur-md">
      <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between px-6 lg:px-12">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button className="bg-primary text-black font-black rounded-lg px-6 hover:brightness-110 transition-all uppercase tracking-widest text-[10px] h-10 shadow-lg border-2 border-gold ring-2 ring-gold/20" asChild>
