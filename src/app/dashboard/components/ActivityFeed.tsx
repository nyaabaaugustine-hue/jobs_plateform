...
const activities = [
  { icon: FileText, text: `You applied for "${DUMMY_JOBS[0].title}"`, time: '2 minutes ago', color: 'primary' },
  ...
  { icon: FileText, text: `You applied for "${DUMMY_JOBS[2].title}"`, time: '1 day ago', color: 'primary' },
];
