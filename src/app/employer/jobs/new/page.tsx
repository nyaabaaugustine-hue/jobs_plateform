...
const SectionTitle = ({ title, description, icon }: { title: string, description: string, icon: React.ReactNode }) => (
    <div className="py-6">
  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
            ...
            <div className="space-y-6">
                ...
                <div>
                    <SectionTitle 
                        ...
                        title="Job Details"
                        description="Provide the fundamental details about the job opening."
                    />
                    <div className="space-y-6">
                ...
                <div>
                    <SectionTitle 
                        ...
                        description="Be detailed and clear to attract the best talent for the role."
                    />
                     <div className="space-y-6">
                        <div className="space-y-2">
                ...
                <div>
                     <SectionTitle 
                        icon={<MessageSquareQuote className="text-primary" />}
                        title="Screening Questions"
                        description="Add questions to help you filter and qualify applicants automatically."
                    />
        ...
        <CardFooter className="p-6 md:p-8 border-t justify-end gap-4">
